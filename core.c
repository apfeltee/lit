...
#define COMPARE(state, callee, a, b) \
    ({ \
        ...
        args[0] = a; \
        args[1] = b; \
        LitInterpretResult r = lit_call(state, callee, args, 2); \
    ...
    static inline LitInterpretResult COMPARE_inl(LitState* state, LitValue callee, LitValue a, LitValue b)
    {
        ...
        args[0] = a;
        args[1] = b;
        return lit_call(state, callee, args, 2);
    }
...
static void run_fiber(LitVm* vm, LitFiber* fiber, LitValue* args, size_t arg_count, bool catcher)
{
...
static inline bool compare(LitState* state, LitValue a, LitValue b)
{
    ...
    args[0] = b;
    return !lit_is_falsey(lit_find_and_call_method(state, a, CONST_STRING(state, "<"), args, 1).result);
}
...
static bool attempt_to_require_combined(LitVm* vm, LitValue* args, size_t arg_count, const char* a, const char* b, bool ignore_previous);

static bool attempt_to_require(LitVm* vm, LitValue* args, size_t arg_count, const char* path, bool ignore_previous, bool folders)
{
    bool found;
    size_t length;
    found = false;
...
static LitValue invalid_constructor(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue class_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue class_iterator(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue class_iteratorValue(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue class_super(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitClass* super = NULL;
...
static LitValue class_subscript(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitClass* klass = AS_CLASS(instance);
...
static LitValue class_name(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue object_class(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(lit_get_class_for(vm->state, instance));
}

static LitValue object_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(lit_string_format(vm->state, "@ instance", OBJECT_VALUE(lit_get_class_for(vm->state, instance)->name)));
}

static LitValue object_subscript(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    if(!IS_INSTANCE(instance))
    {
...
static LitValue object_iterator(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue object_iteratorValue(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    size_t index = LIT_CHECK_NUMBER(0);
    LitInstance* self = AS_INSTANCE(instance);
...
static LitValue number_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(lit_number_to_string(vm->state, AS_NUMBER(instance)));
}

static LitValue number_toChar(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    char ch;
...
static LitValue bool_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue string_plus(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue string_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return instance;
}

static LitValue string_toNumber(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue string_toUpperCase(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    size_t i;
    LitString* rt;
    LitString* string = AS_STRING(instance);
...
static LitValue string_toLowerCase(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    size_t i;
    LitString* rt;
    LitString* string = AS_STRING(instance);
...
static LitValue string_contains(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitString* string = AS_STRING(instance);
...
static LitValue string_startsWith(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitString* string = AS_STRING(instance);
    LitString* sub = LIT_CHECK_OBJECT_STRING(0);
...
static LitValue string_endsWith(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitString* string = AS_STRING(instance);
    LitString* sub = LIT_CHECK_OBJECT_STRING(0);
...
static LitValue string_replace(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(2)
...
static LitValue string_substring(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue string_subscript(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    if(IS_RANGE(args[0]))
    {
...
static LitValue string_less(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return BOOL_VALUE(strcmp(AS_STRING(instance)->chars, LIT_CHECK_STRING(0)) < 0);
}

static LitValue string_greater(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return BOOL_VALUE(strcmp(AS_STRING(instance)->chars, LIT_CHECK_STRING(0)) > 0);
}

static LitValue string_length(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return NUMBER_VALUE(lit_ustring_length(AS_STRING(instance)));
}

static LitValue string_iterator(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitString* string = AS_STRING(instance);
...
static LitValue string_iteratorValue(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitString* string = AS_STRING(instance);
...
static LitValue function_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return lit_get_function_name(vm, instance);
}

static LitValue function_name(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return lit_get_function_name(vm, instance);
}
...
static LitValue fiber_constructor(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue fiber_done(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return BOOL_VALUE(is_fiber_done(AS_FIBER(instance)));
}

static LitValue fiber_error(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return AS_FIBER(instance)->error;
}

static LitValue fiber_current(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static bool fiber_run(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    run_fiber(vm, AS_FIBER(instance), args, arg_count, false);
    return true;
}

static bool fiber_try(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    run_fiber(vm, AS_FIBER(instance), args, arg_count, true);
    return true;
}

static bool fiber_yield(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    if(vm->fiber->parent == NULL)
    {
        lit_handle_runtime_error(vm, arg_count == 0 ? CONST_STRING(vm->state, "Fiber was yielded") :
                                                      lit_to_string(vm->state, args[0]));
        return true;
    }
...
static bool fiber_yeet(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    if(vm->fiber->parent == NULL)
    {
        lit_handle_runtime_error(vm, arg_count == 0 ? CONST_STRING(vm->state, "Fiber was yeeted") :
                                                      lit_to_string(vm->state, args[0]));
        return true;
    }
...
static bool fiber_abort(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    lit_handle_runtime_error(vm, arg_count == 0 ? CONST_STRING(vm->state, "Fiber was aborted") :
                                                  lit_to_string(vm->state, args[0]));
    args[-1] = NULL_VALUE;
    return true;
}
...
static LitValue module_privates(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue module_current(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(vm->fiber->module);
}

static LitValue module_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(lit_string_format(vm->state, "Module @", OBJECT_VALUE(AS_MODULE(instance)->name)));
}

static LitValue module_name(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue array_constructor(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(lit_create_array(vm->state));
}


static LitValue array_slice(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    int from = LIT_CHECK_NUMBER(0);
    int to = LIT_CHECK_NUMBER(1);
...
static LitValue array_subscript(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    if(arg_count == 2)
    {
        if(!IS_NUMBER(args[0]))
...
static LitValue array_add(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue array_insert(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(2)
...
static LitValue array_addAll(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue array_indexOf(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue array_remove(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue array_removeAt(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    int index = LIT_CHECK_NUMBER(0);
...
static LitValue array_contains(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
    return BOOL_VALUE(indexOf(AS_ARRAY(instance), args[0]) != -1);
}

static LitValue array_clear(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    AS_ARRAY(instance)->values.count = 0;
    return NULL_VALUE;
}

static LitValue array_iterator(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue array_iteratorValue(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    size_t index = LIT_CHECK_NUMBER(0);
    LitValues* values = &AS_ARRAY(instance)->values;
...
static LitValue array_join(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitValues* values = &AS_ARRAY(instance)->values;
...
static LitValue array_sort(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitValues* values = &AS_ARRAY(instance)->values;
...
static LitValue array_clone(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue array_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitValues* values = &AS_ARRAY(instance)->values;
    LitState* state = vm->state;
...
static LitValue array_length(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue map_constructor(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return OBJECT_VALUE(lit_create_map(vm->state));
}

static LitValue map_subscript(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    if(!IS_STRING(args[0]))
    {
...
static LitValue map_addAll(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue map_clear(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    AS_MAP(instance)->values.count = 0;
    return NULL_VALUE;
}

static LitValue map_iterator(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
    int index = args[0] == NULL_VALUE ? -1 : AS_NUMBER(args[0]);
...
static LitValue map_iteratorValue(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    size_t index = LIT_CHECK_NUMBER(0);
    return table_iterator_key(&AS_MAP(instance)->values, index);
}

static LitValue map_clone(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitState* state = vm->state;
...
static LitValue map_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitState* state = vm->state;
    LitMap* map = AS_MAP(instance);
...
static LitValue map_length(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
...
static LitValue range_iterator(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
...
static LitValue range_iteratorValue(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LIT_ENSURE_ARGS(1)
    return args[0];
}

static LitValue range_toString(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitRange* range = AS_RANGE(instance);
    return OBJECT_VALUE(lit_string_format(vm->state, "Range(#, #)", range->from, range->to));
}

static LitValue range_from(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return NUMBER_VALUE(AS_RANGE(instance)->from);
}

static LitValue range_set_from(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    AS_RANGE(instance)->from = AS_NUMBER(args[0]);
    return args[0];
}

static LitValue range_to(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    return NUMBER_VALUE(AS_RANGE(instance)->to);
}

static LitValue range_set_to(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    AS_RANGE(instance)->to = AS_NUMBER(args[0]);
    return args[0];
}

static LitValue range_length(LitVm* vm, LitValue instance, size_t arg_count, LitValue* args)
{
    LitRange* range = AS_RANGE(instance);
 ...
 */
 ...
 static LitValue cfn_time(LitVm* vm, size_t arg_count, LitValue* args)
{
    return NUMBER_VALUE((double)clock() / CLOCKS_PER_SEC);
}

 static LitValue cfn_systemTime(LitVm* vm, size_t arg_count, LitValue* args)
{
    return NUMBER_VALUE(time(NULL));
}

 static LitValue cfn_print(LitVm* vm, size_t arg_count, LitValue* args)
{
    size_t i;
    if(arg_count == 0)
    {
    ...
    {
        lit_printf(vm->state, "%s", lit_to_string(vm->state, args[i])->chars);
    }
    return NULL_VALUE;
}


static bool eval_primitive(LitVm* vm, size_t arg_count, LitValue* args)
{
...
static bool require_primitive(LitVm* vm, size_t arg_count, LitValue* args)
{
